...
import { emailExistStudent, userExistsById } from "../helpers/db-validators.js";
...
export const registerValidator = [
    ...
    body("email").custom(emailExistStudent),
...
export const updatePasswordValidator = [
    param("uid").isMongoId().withMessage("No es un ID válido de MongoDB"),
    param("uid").custom(userExistsById),
    body("newPassword").isLength({ min: 8 }).withMessage("La contraseña debe contener al menos 8 caracteres"),
    validarCampos,
    handleErrors
];
